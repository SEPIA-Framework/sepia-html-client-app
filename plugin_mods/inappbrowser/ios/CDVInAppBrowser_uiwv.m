...
- (void)createViews
{
	...
	/*
	NSString* closeButtonString = NSLocalizedString(@"×", nil); // create arrow from Unicode char
    self.closeButton = [[UIBarButtonItem alloc] initWithTitle:closeButtonString style:UIBarButtonItemStyleBordered target:self action:@selector(close)];
    self.closeButton.enabled = YES;
	...
	*/
    ...
    self.addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 5.0, self.view.bounds.size.width - 170.0, LOCATIONBAR_HEIGHT)];
    self.addressLabel.adjustsFontSizeToFitWidth = NO;
    self.addressLabel.alpha = 1.000;
    self.addressLabel.autoresizesSubviews = YES;
    self.addressLabel.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin;
    self.addressLabel.backgroundColor = [UIColor colorWithRed:60.0 / 255.0 green:136.0 / 255.0 blue:230.0 / 255.0 alpha:0.0 ]; //[UIColor clearColor];
    ...
    //UITapGestureRecognizer *tapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(copyUrlToClipboard:)];
    //[self.addressLabel addGestureRecognizer:tapGesture];
    
    UIBarButtonItem *urlButton = [[UIBarButtonItem alloc] initWithCustomView:self.addressLabel];
    
    UIBarButtonItem *urlCopyBtn = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(copyUrlToClipboard:)];
    urlCopyBtn.enabled = YES;
	...
	[self.toolbar setItems:@[self.closeButton, flexibleSpaceButton, urlButton, fixedSpaceButton2, urlCopyBtn, flexibleSpaceButton2, self.backButton, fixedSpaceButton, self.forwardButton, fixedSpaceButton2]];
