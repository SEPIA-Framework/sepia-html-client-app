...
@property (nonatomic, assign) BOOL disableswipenavigation;
...
@property (nonatomic, strong) IBOutlet UIBarButtonItem* contextBtn;
@property (nonatomic, strong) IBOutlet UIBarButtonItem* searchBtn;
@property (nonatomic, strong) IBOutlet UIBarButtonItem* urlButton;
@property (nonatomic, strong) IBOutlet UIActivityIndicatorView* spinner;
@property (nonatomic, strong) IBOutlet UIToolbar* toolbar;
@property (nonatomic, strong) IBOutlet UIToolbar* contextBar;
