...
v21en="https://sepia-framework.github.io/files/porcupine/2.1_en/pv_porcupine.wasm"
v21de="https://sepia-framework.github.io/files/porcupine/2.1_de/pv_porcupine.wasm"
echo "Downloading Porcupine keyword files for version 1.5, 1.6, 1.9 and 2.1 (en, de)..."
echo
...
wget -O "pv_porcupine_2.1_en.wasm" "$v21en"
wget -O "pv_porcupine_2.1_de.wasm" "$v21de"
echo "DONE"
ls -l | grep "\.wasm"
echo
