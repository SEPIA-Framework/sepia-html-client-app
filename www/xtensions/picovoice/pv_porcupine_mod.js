    ...
    return (
        function(PorcupineModule) {
            ...
            if (ENVIRONMENT_IS_NODE) {
				...
				if ('SepiaFW' in window && window.SepiaFW.files) {
            ...
            function integrateWasmJS() {
                ...
                var wasmBinaryFile = ('SepiaFW' in window && window.SepiaFW.files)? 
					SepiaFW.wakeTriggers.getPorcupineWwData().engineFile : "pv_porcupine.wasm";
